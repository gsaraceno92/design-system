...
| `htmlautocomplete` | `htmlautocomplete` | autocomplete attribute for storing and autofilling credentials (optional): available for text, password, number, email | `string`                                                                                                                                                                                         | `undefined`  |
